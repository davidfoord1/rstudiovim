...
There are non-recursive `noremap` equivalents for the different modes, which is
useful if you want to replace existing mappings with improved functionality.
This allows us to do things like centre the screen on search results:
